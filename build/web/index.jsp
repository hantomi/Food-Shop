<%-- 
    Document   : index
    Created on : Jan 10, 2021, 12:13:05 PM
    Author     : redra
--%>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 left-rs">
                            <div class="navbar-header">
                                ...
                                <a href="LogDataController" class="navbar-brand"><img src="images/logo.png" alt="" /></a>
                            </div>
                            ...
                            <div class="right-nav">
                                <div class="login-sr">
                                    <div class="login-signup">
                                        <ul>
                                            <li><a href="/J3.L.P0013/log.jsp">Login</a></li>
                                            <li><a class="custom-b" href="/J3.L.P0013/log.jsp">Sign up</a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="find-box">
                            ...
                            <h4>It has never been more convenience.</h4>
                            <form action="/J3.L.P0013/SearchController" method="POST">
                                <div class="product-sh">
                                    <div class="col-sm-6">
                                        <div class="form-sh">
                                            <param name="pageURL" value="index.jsp"/>
                                            <input type="text" placeholder="Search something you love" name="txtProductSearch" >
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-sh">
                                            <select class="selectpicker" name="cbbCategories">
                                                <option>none</option>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-sh"> <button class="btn">Search</button> </div>
                                    </div>
                    ...
                    <div class="row clearfix">
                        <!--1 product-->
                        <c:forEach items="${applicationScope.listPro}" var="proDTO">
                            <div class="col-lg-3 col-sm-6 col-md-3">
                                <a href="log.jsp">
                                    <div class="box-img">
                                        <h4>${proDTO.name}</h4>
                                        <img src="images/product/${proDTO.img}" alt="#" />
                                    </div>
                                </a>
                            </div>
                        </c:forEach>
                        ...
                        <div class="categories_link">
                            <a href="log.jsp">Browse all categories here</a>
                        </div>
                    </div>
                </div>
            </div>
