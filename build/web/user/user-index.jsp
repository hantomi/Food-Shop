<%-- 
    Document   : user-index
    Created on : Jan 20, 2021, 4:09:29 PM
    Author     : redra
--%>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 left-rs">
                            <div class="navbar-header">
                                ...
                                <a href="/J3.L.P0013/LogDataController" class="navbar-brand"><img src="images.logo.png" alt="#" /></a>
                            </div>
            ...
            <div class="main-product">
                <div class="container">
                    <div class="row clearfix">
                        <form action="/J3.L.P0013/UserSearchController" method="POST">
                            <div class="find-box">
                    ...
                    <div class="row clearfix">
                        ...
                        <c:forEach var="dto" items="${applicationScope.listProduct}">
                            <div class="col-lg-3 col-sm-6 col-md-3">
                                <a href="/J3.L.P0013/UserLogProductController?productID=${dto.id}">
                                    <div class="box-img">
                                        <h4>${dto.name}</h4>
