<%-- 
    ...
    Created on : Jan 20, 2021, 5:09:04 PM
    Author     : redra
--%>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 left-rs">
                            <div class="navbar-header">
                                ...
                                <a href="/J3.L.P0013/UserProductLogController" class="navbar-brand"><img src="images/logo.png" alt="" /></a>
                            </div>
                                        ...
                                        <ul>
                                            <li><a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                                    <c:if test="${not empty sessionScope.cart.cart.values()}">
                                                        <div>${sessionScope.cart.cart.values().size()}</div>
                                                    </c:if>
                                                </a>
                                            </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="prod-page-title">
                            <h2>${requestScope.SelectedProduct.name}</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-8">
                        <div class="md-prod-page">
                            ...
                            <div class="description-box">
                                <div class="dex-a">
                                    <h4>Description</h4>
                                    <p>${requestScope.SelectedProduct.desc}
                                    </p>
                                    <br>
                                </div>
                                <div class="spe-a">
                                    ...
                                    <ul>
                                        <li class="clearfix">
                                            ...
                                            <div class="col-md-8">
                                                <p>${requestScope.SelectedProduct.stock}</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <p>${requestScope.SelectedProduct.size}</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <p>${requestScope.SelectedProduct.shipping}</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8">
                                                <p>${requestScope.SelectedProduct.delivery}</p>
                                            </div>
                                        </li>
                                        <br />
                                        <br />
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="price-box-right">
                            <h4>Price</h4>
                            <h3>${requestScope.SelectedProduct.price}</h3>
                            <p>Category <span>${requestScope.currCategory}</span></p>
                            <p>Quantity:</p>
                            <input type="text" value="1" name="txtQuantity" id="quantity-text"
                                   onkeypress="return isNumberKey(event)" />
                            <a href="/J3.L.P0013/UserAddToCartController?id=${requestScope.SelectedProduct.id}"><button>Add to Cart</button></a>
                            <h5><i class="fa fa-clock-o" aria-hidden="true"></i> <strong>${requestScope.SelectedProduct.deliveryTime}</strong> avg. delivery
                                time</h5>
                        </div>
                    </div>
                </div>
