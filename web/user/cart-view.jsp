<%-- 
    Document   : cart-view
    Created on : Jan 20, 2021, 10:54:59 PM
    Author     : redra
--%>
   ...
   <body>
                     ...
                     <div class="right-nav">
                        <div class="login-sr">
                           <div class="login-signup">
                              <ul>
                                 <li><a href="#"><a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                 <div>2</div></a></li>
                                 <li><a class="custom-b" href="#">Logout</a></li>
                              </ul>
                           </div>
                        </div>
                        <div class="help-r hidden-xs">
                           <div class="help-box">
                              <ul>
                                 ...
                                 <li> <a href="#"><img class="h-i" src="images/help-icon.png" alt="" /> ${applicationScope.UserName} </a> </li>
                              </ul>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-md-5 col-sm-6 col-xs-12">
                  <div class="left-works-box wow fadeIn" data-wow-delay="0.2s">
                     <h2>Your... <br><span>Cart</span></h2>
                     <div class="box">
                        <ul>
                           <a href="#"><li><span>1</span>French Fries</li></a>
                           <a href="#"><li><span>2</span>Apple Juice</li></a>
                        </ul>
                     </div>
                     <button name="action" value="Order">Confirm Order</button>
                  </div>
               </div>
               <div class="col-md-7 col-sm-6 col-xs-12">
                  <div class="right-works-box">
                     <div class="small-box wow fadeIn" data-wow-delay="0.2s">
                        <div class="how-text-left"> </div>
                        <div class="how-dit-right">
                           <div class="dit-img">
                              <img class="img-responsive" src="images/works-icon-01.png" alt="" />
                           </div>
                           <h2><span>Product's </span><br> infomations</h2>
                           <div class="spe-a">
                              <ul>
                                 <li class="clearfix">
                                    <div class="col-md-4">
                                 ...
                                 <li class="clearfix">
                                    ...
                                    <div class="col-md-8">
                                       <p><input type="text" value="3" name="txtPrice" required="" /></p>
                                    </div>
                                 </li>
                                 <br />
                                 <br />
      ...
      <div class="section-safety">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h2>Benefis with trust and safety</h2>
               </div>
